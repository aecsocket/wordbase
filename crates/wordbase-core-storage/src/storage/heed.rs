...
/// [`storage::Storage`] implementation which uses the [`heed`] wrapper around
/// [LMDB](https://en.wikipedia.org/wiki/Lightning_Memory-Mapped_Database).
#[derive(Debug, Clone)]
pub struct Heed;

impl storage::Storage for Heed {
...
/// [`storage::ImportStorage`] for [`Heed`].
#[derive(Debug)]
...
/// [`storage::ImportTransaction`] for [`Heed`].
#[derive(Debug)]
...
/// [`storage::LookupStorage`] for [`Heed`].
#[derive(Debug)]
